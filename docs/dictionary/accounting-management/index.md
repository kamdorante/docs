...
## Hechos Contables
### Ventanas
- [Detalle de Hechos Contables](fact-details/accounting-fact-details-window)
- [Saldos de Hechos Contables](fact-details/accounting-fact-balances)

### Reportes
- [Reporte de Detalle](fact-details/accounting-fact-details-report)
- [Hechos Contables Diarios](fact-details/accounting-fact-daily)
- [Hechos Contables por Período](fact-details/accounting-fact-period)
- [Verificación de Cuentas Puente](fact-details/bridge-account-verification)

## Conciliación Contable
- [Conciliación Automática](reconciliation/automatic-account-reconciliation)
- [Conciliación Manual](reconciliation/accounting-fact-reconciliation-manual)
- [Hechos sin Conciliar](reconciliation/unreconciled-accounting-facts)
- [Conciliación Manual con Diferencia en Montos](reconciliation/bank-statement-assignment-with-difference)
